...
# start from scratch
exec ./src/kde-builder/kde-builder --rc-file=~/projects/kde/kdesrc-buildrc --include-dependencies baloo breeze plasma-integration kwayland-integration konsole kate
